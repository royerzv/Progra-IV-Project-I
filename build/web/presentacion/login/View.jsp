        ...
        <form name="form" action="/Proyecto 1/presentacion/login/login" method="post" > 
            <div class="panel" style="width:30%;">
                ...
                <div ><label> <%=title("errorFld",errores)%> </label></div>
                    ...
                    <div style="display: flex; justify-content: space-around; align-items: center;">
                        <img src="/Proyecto 1/images/password.png" alt="" width="20" height="20"/>
                    ...
                    <div style="display: flex; justify-content: space-around; align-items: center;">
                        <img src="/Proyecto 1/images/Usuario 1.png" alt="" width="20" height="20"/>
                        <input type="radio" id="cliente" name="tipoUsuario" value="Paciente">
                        <label for="cliente">Cliente</label>
                        <img src="/Proyecto 1/images/Doctor.png" alt="" width="20" height="20"/>
                        <input type="radio" id="doctor" name="tipoUsuario" value="Medico">
                        <label for="doctor">Doctor</label>
                        <img src="/Proyecto 1/images/Administrador.png" alt="" width="20" height="20"/>
                ...
                <div style="display: flex; justify-content: space-around; align-items: center;">
                    <a href="/Proyecto 1/presentacion/registro/cliente/show" style="color: rgb(39, 77, 122); text-decoration: none;"> >>>Paciente<<< </a>
                    <a href="/Proyecto 1/presentacion/registro/medico/show" style="color: rgb(39, 77, 122); text-decoration: none;"> >>>Medico<<< </a>
                </div>
            </div>
        </form>
