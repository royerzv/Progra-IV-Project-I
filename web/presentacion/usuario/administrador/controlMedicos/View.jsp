                            ...
                            <li>
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div>
                                        ...
                                        <div><a href="/Proyecto 1 v3/presentacion/usuario/administrador/controlMedicos/activar?idMedico=<%=medico.getCedula()%>" style="text-align: center; color: aliceblue; background-color: #003333; text-decoration-line: none;">Activar cuenta</a></div>
                                    </div>
                                </div>
                            </li>
                            <%
