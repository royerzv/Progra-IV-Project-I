...
public class Controller extends HttpServlet
{
  protected void processRequest(HttpServletRequest request, 
    ...
    Map<String,String> validar(HttpServletRequest request)
    {
        ...
        if(!request.getParameter("cedulaFld").isEmpty())
        {
            if(service.esMedico(request.getParameter("cedulaFld")))
            {
                if(!(service.medicoActivo(request.getParameter("cedulaFld"))))
                {
                    errores.put("cedulaFld", "Usuario sin activar");
                }
            }
        }
    ...
    public String loginAction(HttpServletRequest request)
    {
        ...
        try 
        {
            Usuario real = service.usuarioFind(model.getCurrent().getCedula(),model.getCurrent().getClave(),request.getParameter("tipoUsuario"));
